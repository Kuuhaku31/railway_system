...
Controller::ControlerInit()
{
    ...
    database[3]  = { 4, "G1237", "北京", "上海", { 2021, 1, 1, 8, 0, 0 }, { 2021, 1, 1, 12, 0, 0 }, 100, 100.0f, TrainStatus::STOP };
    database[4]  = { 5, "G1238", "北京", "上海", { 2021, 1, 1, 8, 0, 0 }, { 2021, 1, 1, 12, 0, 0 }, 100, 100.0f, TrainStatus::STOP };
    database[5]  = { 6, "G1239", "北京", "上海", { 2021, 1, 1, 8, 0, 0 }, { 2021, 1, 1, 12, 0, 0 }, 100, 100.0f, TrainStatus::DELAY };
    database[6]  = { 7, "G1240", "北京", "上海", { 2021, 1, 1, 8, 0, 0 }, { 2021, 1, 1, 12, 0, 0 }, 100, 100.0f, TrainStatus::NORMAL };
    database[7]  = { 8, "G1241", "北京", "上海", { 2021, 1, 1, 8, 0, 0 }, { 2021, 1, 1, 12, 0, 0 }, 100, 100.0f, TrainStatus::NORMAL };
    database[8]  = { 9, "G1242", "北京", "上海", { 2021, 1, 1, 8, 0, 0 }, { 2021, 1, 1, 12, 0, 0 }, 100, 100.0f, TrainStatus::NORMAL };
    ...
    database[12] = { 13, "G1236", "北京", "上海", { 2021, 1, 1, 8, 0, 0 }, { 2021, 1, 1, 12, 0, 0 }, 100, 100.0f, TrainStatus::NORMAL };
    database[13] = { 14, "G1237", "北京", "上海", { 2021, 1, 1, 8, 0, 0 }, { 2021, 1, 1, 12, 0, 0 }, 100, 100.0f, TrainStatus::STOP };
    ...
    database[18] = { 19, "G1242", "北京", "上海", { 2021, 1, 1, 8, 0, 0 }, { 2021, 1, 1, 12, 0, 0 }, 100, 100.0f, TrainStatus::STOP };
...
int32_t
Controller::RailwaySystemSearchTrainData(int32_t flag)
{
    train_datas.clear();
    if(flag < 0)
    {
